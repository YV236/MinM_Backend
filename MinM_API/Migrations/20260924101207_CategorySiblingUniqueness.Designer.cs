...
namespace MinM_API.Migrations
{
    ...
    [Migration("20260924101207_CategorySiblingUniqueness")]
    partial class CategorySiblingUniqueness
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinM_API.Models.Category", b =>
                {
                    ...
                    b.HasIndex("Slug", "ParentCategoryId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MinM_API.Models.PostAddress", b =>
                {
                    b.HasBaseType("MinM_API.Models.Address");

                    b.Property<string>("PostDepartment")
                        .IsRequired()
                        .HasColumnType("text");

                    b.ToTable("PostAddresses", (string)null);
                });

            modelBuilder.Entity("MinM_API.Models.UserAddress", b =>
                {
                    b.HasBaseType("MinM_API.Models.Address");
            ...
            modelBuilder.Entity("MinM_API.Models.User", b =>
                {
                    b.HasOne("MinM_API.Models.UserAddress", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("MinM_API.Models.PostAddress", b =>
                {
                    b.HasOne("MinM_API.Models.Address", null)
                        .WithOne()
                        .HasForeignKey("MinM_API.Models.PostAddress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("MinM_API.Models.UserAddress", b =>
                {
                    b.HasOne("MinM_API.Models.Address", null)
                        .WithOne()
                        .HasForeignKey("MinM_API.Models.UserAddress", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
